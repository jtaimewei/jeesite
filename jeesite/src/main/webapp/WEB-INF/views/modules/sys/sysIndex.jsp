...
<head>
	<title>${fns:getConfig('productName')}</title>
	 ...
	 <!-- Icons -->
    <link href="${ctxStatic}/coreui/css/font-awesome.min.css" rel="stylesheet">
    <link href="${ctxStatic}/coreui/css/simple-line-icons.css" rel="stylesheet">

    <!-- Main styles for this application -->
    <link href="${ctxStatic}/coreui/css/style.css" rel="stylesheet">
...
<body class="app header-fixed sidebar-fixed aside-menu-fixed aside-menu-hidden">
	...
	<header class="app-header navbar">
        ...
        <ul id="menu" class="nav navbar-nav hidden-md-down">
            <li class="nav-item">
			...
			<c:set var="firstMenu" value="true"/>
				<c:forEach items="${fns:getMenuList()}" var="menu" varStatus="idxStatus">
					<c:if test="${menu.parent.id eq '1'&&menu.isShow eq '1'}">
						<li class="nav-item px-1 menu">
							<c:if test="${empty menu.href}">
								<a class="nav-link menu" href="javascript:" data-href="${ctx}/sys/menu/tree?parentId=${menu.id}" data-id="${menu.id}">${menu.name}</a>
							</c:if>
							<c:if test="${not empty menu.href}">
								<a class="nav-link" href="${fn:indexOf(menu.href, '://') eq - 1 ? ctx : ''}${menu.href}" data-id="${menu.id}" target="mainFrame">${menu.name}</a>
							</c:if>
						</li>
						<c:if test="${firstMenu}">
							<c:set var="firstMenuId" value="${menu.id}"/>
        ...
        <ul class="nav navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle nav-link" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">
                    <img src="${ctxStatic}/coreui/img/avatars/6.jpg" class="img-avatar" alt="admin@bootstrapmaster.com">
...
<c:set var="firstMenu" value="true"/>
<c:forEach items="${menuList}" var="menua" varStatus="idxStatus">
<c:if test="${menua.parent.id eq 'd60e9e15cc124ebeaa0c80066e7ffb03'&&menua.isShow eq '1'}">
<li class="nav-item nav-dropdown">
             <a class="nav-link nav-dropdown-toggle" href="#"><i class="icon-puzzle"></i> ${menua.name}</a>
             <ul class="nav-dropdown-items">
             	<c:forEach items="${menuList}" var="menu2">
					<c:if test="${menu2.parent.id eq menua.id&&menu2.isShow eq '1'}">
                 <li class="nav-item">
                     <a class="nav-link" href="${fn:indexOf(menu2.href, '://') eq -1 ? ctx : ''}${not empty menu2.href ? menu2.href : '/404'}" target="${not empty menu2.target ? menu2.target : 'mainFrame'}"><i class="icon-puzzle"></i>${menu2.name}</a>
                 </li>
                 <c:set var="firstMenu" value="false"/>
                 </c:if>
                 </c:forEach>
	...
	<script src="${ctxStatic}/coreui/assets/js/libs/jquery.min.js"></script>
	<script src="${ctxStatic}/coreui/assets/js/libs/tether.min.js"></script>
	<script src="${ctxStatic}/coreui/assets/js/libs/bootstrap.min.js"></script>
	<script src="${ctxStatic}/coreui/assets/js/libs/pace.min.js"></script>
	<!-- Plugins and scripts required by all views -->
	<script src="${ctxStatic}/coreui/assets/js/libs/Chart.min.js"></script>
	
	<script src="${ctxStatic}/coreui/js/app.js"></script>
	<script src="${ctxStatic}/coreui/js/views/main.js"></script>
